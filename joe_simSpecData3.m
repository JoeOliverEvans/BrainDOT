...
all_dOD = zeros(nchannel*2, samples);
...
for rep=1:samples
    ...
    all_dOD(:,rep) = [J750.complete*(togrid*(E(1,1)*beta-E(1,2)*beta/all_ratio(rep))); J850.complete*(togrid*(E(2,1)*beta-E(2,2)*beta/all_ratio(rep)))];
end
% Add 2% noise to dOD
...
J_spec = [[J750.complete*E(1,1), J750.complete*E(1,2)]; [J850.complete*E(2,1), J850.complete*E(2,2)]];
clear J750 J850
